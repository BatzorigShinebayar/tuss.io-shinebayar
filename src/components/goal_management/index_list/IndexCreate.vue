<template>
  <div>
          ...
          <b-row>
            <b-col lg="3">
              <b-form-group label="Index ID">
                ...
                ></b-form-input>
                <span
                  v-if="!$v.indexId.required && formSubmit"
                  class="text-danger"
                >
            ...
            <b-col lg="9">
              <b-form-group label="Index Name">
                ...
                ></b-form-input>
                <span
                  v-if="!this.$v.indexName.required && formSubmit"
                  class="text-danger"
                >
            ...
            <b-col lg="12">
              ...
              >
                ...
                ></b-form-input>
                <span
                  v-if="!$v.unit.required && formSubmit"
                  class="text-danger"
                >
            ...
            <b-col lg="12">
              <b-form-group label="Index calculation equation">
                ...
                ></b-form-input>
                <span
                  v-if="!$v.equation.required && formSubmit"
                  class="text-danger"
                >
    ...
    <b-modal id="create-index-modal" centered>
      <h4 class="text-center">Index created</h4>
  ...
  methods: {
    ...
    createIndex() {
      ...
      if (!this.$v.$invalid) {
        ...
        const url = 'pages/goal/create_goal_index/';

        axios.post(url, payload).then(() => {
          this.$root.$emit('bv::toggle::collapse', 'goal-index-create');
          this.$bvModal.show('create-index-modal');
